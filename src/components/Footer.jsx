...
const Footer = () => {
  return (
    <footer className="text-gray-700 py-4 px-4 text-center shadow-md">
      <div className="flex justify-center items-center space-x-4">
        <a href="https://github.com/matsu128" target="_blank" rel="noopener noreferrer">
          <svg className="h-6 w-6 fill-current text-gray-600 hover:text-gray-900" viewBox="0 0 24 24">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <a href="https://www.linkedin.com/in/sou-m-868661276" target="_blank" rel="noopener noreferrer">
          <svg className="h-6 w-6 fill-current text-gray-600 hover:text-gray-900" viewBox="0 0 24 24">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
